...
import { Calendar, Check, ListPlus, Plus, Star, Trash2 } from "lucide-react";
    ...
    <>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        <div className="flex items-center justify-between py-4">
          <h1 className="text-2xl font-bold tracking-tight">Speweek Curator</h1>
                  ...
                  <FieldGroup>
                    <Controller
                      ...
                      render={({ field, fieldState }) => (
                        ...
                        >
                          <FieldLabel className="text-right">Theme</FieldLabel>
